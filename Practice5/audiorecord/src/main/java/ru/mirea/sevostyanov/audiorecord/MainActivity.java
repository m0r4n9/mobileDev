package ru.mirea.sevostyanov.audiorecord;
...
import ru.mirea.sevostyanov.audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (!isWork) finish(); // Закрыть приложение, если нет разрешений
    }
